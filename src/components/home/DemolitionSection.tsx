          ...
          <motion.div key={cap.slug} variants={itemVariants}>
            ...
            >
              ...
              >
                ...
                <span
                  className="font-body group-hover:text-[oklch(41%_0.144_264)] transition-colors duration-150"
                  style={{ fontSize: '0.75rem', color: 'oklch(48% 0.012 264)' }}
                >
                  {isAr ? '←' : '→'}
                </span>
              </div>
